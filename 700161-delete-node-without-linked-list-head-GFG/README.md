# [Delete Node Without Linked List Head](https://www.geeksforgeeks.org/problems/delete-without-head-pointer/1?page=1&category=Java,Linked%20List&sortBy=submissions)
## Medium
